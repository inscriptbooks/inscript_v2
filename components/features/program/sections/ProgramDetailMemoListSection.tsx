...
interface ProgramDetailMemoListSectionProps {
...
export default function ProgramDetailMemoListSection({
  programMemoList,
  onMoreClick,
  hasNextPage,
  isFetchingNextPage,
}: ProgramDetailMemoListSectionProps) {
  return (
      ...
      <div className="mx-auto flex w-full max-w-[793px] flex-col justify-center gap-7">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-serif text-xl font-bold text-orange-3 lg:text-[28px]">
            {programMemoList.length}
          </span>
        </div>

        {programMemoList.length > 0 ? (
          <>
            <MemoList
