...
export default function MyPageHistoryLikesPostSection() {
  ...
  } = useGetLikedPosts({ type: "recruit", limit: 5 });
  ...
  } = useGetLikedPosts({ type: "qna", limit: 5 });
  ...
  } = useGetLikedPosts({ type: "market", limit: 5 });
  ...
  } = useGetLikedPosts({ type: "promotion", limit: 5 });
