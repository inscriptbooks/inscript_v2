...
import { AuthorMemoDetailSection } from "@/components/features/author/sections";
...
export default function AuthorDetailMemoPage() {
  ...
  return (
    <section className="flex w-full flex-1 flex-col gap-10 px-[20px] pt-11 lg:px-[120px] lg:pt-[80px]">
      <MemoPreviewCard memo={memo} hasLink={false} hideTitle />
      <AuthorMemoDetailSection authorMemo={memo} commentList={commentList} />
    </section>
  );
}
